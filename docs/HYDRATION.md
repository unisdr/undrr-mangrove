...
<script type="module">
  import createHydrator from 'https://assets.undrr.org/static/mangrove/1.6.0/components/hydrate.js';
  import ShareButtons, { fromElement } from 'https://assets.undrr.org/static/mangrove/1.6.0/components/ShareButtons.js';
