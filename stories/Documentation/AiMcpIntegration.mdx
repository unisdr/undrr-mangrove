...
Agents that can read files (Claude Code, Cursor, Copilot) do best with the GitHub repository. The repo has `CLAUDE.md` and `.github/copilot-instructions.md` with project context baked in.
...
If you're working inside the Mangrove repo, Claude Code picks up `CLAUDE.md` automatically.
...
The repo has a `.github/copilot-instructions.md`. For consuming projects, a comment at the top of your file works:
