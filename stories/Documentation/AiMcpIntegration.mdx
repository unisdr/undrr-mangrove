...
The [utilities reference](https://unisdr.github.io/undrr-mangrove/ai-components/utilities.json) (~25 KB) lists all CSS utility classes grouped into 12 categories. Each class has a description and usage example.
