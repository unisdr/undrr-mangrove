...
<a
  ...
  onClick={linkTo('getting-started-vanilla-html-css', 'docs')}
>
...
<a
  href="javascript:void(0)"
  onClick={linkTo('getting-started-sass-integration', 'docs')}
>
...
<a
  href="javascript:void(0)"
  onClick={linkTo('getting-started-react-integration', 'docs')}
>
