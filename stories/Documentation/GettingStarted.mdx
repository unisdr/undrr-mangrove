...
<TableOfContents
  tocData={[
    ...
    { id: 'analytics-enhancements', text: 'Analytics enhancements' },
...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://assets.undrr.org/static/mangrove/1.2.11/assets/css/style.css"
    />
    <!-- or choose a site specific theme -->
    <link
      rel="stylesheet"
      href="https://assets.undrr.org/static/mangrove/1.2.11/assets/css/style-mcr.css"
    />
    <link
      rel="stylesheet"
      href="https://assets.undrr.org/static/mangrove/1.2.11/assets/css/style-irp.css"
    />
    <link
      rel="stylesheet"
      href="https://assets.undrr.org/static/mangrove/1.2.11/assets/css/style-preventionweb.css"
    />
  </head>
  <body>
    <!-- 2. Use any component -->
...
For GA4 helpers and UNDRR domain configuration, see the dedicated entry:

<LinkTo kind="getting-started-analytics-enhancements" story="docs">
  → Analytics enhancements (CDN and script)
</LinkTo>

Or open the CDN resources directly:

- [Analytics CDN index](https://assets.undrr.org/static/analytics/v1.0.0/index.html)
