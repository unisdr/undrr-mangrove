...
See <LinkTo kind="contributing-component-standards" story="docs">Component standards</LinkTo> for the full conventions.
...
- [ ] Component works across all four themes without contrast failures

See <LinkTo kind="getting-started-accessibility" story="docs">Accessibility</LinkTo> for the full guide and testing methodology.
...
See <LinkTo kind="contributing-writing-guidelines" story="docs">Writing guidelines</LinkTo> for UX writing standards.
...
See <LinkTo kind="contributing-build-a-component-testing" story="docs">Testing</LinkTo> for the testing setup and patterns.
...
See the RTL support section in <LinkTo kind="contributing-component-standards" story="docs">Component standards</LinkTo>.
...
See the <LinkTo kind="getting-started-integration-hydration-guide" story="docs">Hydration guide</LinkTo> for the full pattern.
