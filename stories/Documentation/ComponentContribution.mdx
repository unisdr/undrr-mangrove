...
<Meta
  title="Getting started/Component standards"
  parameters={{
    viewMode: 'docs',
    previewTabs: {
      canvas: { hidden: true },
...
Standards, conventions, and contribution process for Mangrove components. For a step-by-step tutorial on building a new component, see the <LinkTo kind="getting-started-build-a-component-step-by-step" story="docs">Build a component</LinkTo> guide.
...
- **<LinkTo kind="getting-started-build-a-component-step-by-step" story="docs">Build a component</LinkTo>** — step-by-step tutorial
- **<LinkTo kind="getting-started-build-a-component-testing" story="docs">Testing components</LinkTo>** — unit, visual, and accessibility testing
...
For the full testing setup, patterns, and commands, see the <LinkTo kind="getting-started-build-a-component-testing" story="docs">testing guide</LinkTo>.
...
See the <LinkTo kind="getting-started-build-a-component-review-checklist" story="docs">review checklist</LinkTo> for the full validation checklist covering structure, accessibility, documentation, testing, internationalization, and Drupal integration.
