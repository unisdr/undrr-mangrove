...
1. **Component Documentation**
    ...
    */
   export function Button({ variant, size = 'md', isFullWidth = false, isDisabled = false, onClick, children, ...props }) {
     // Implementation
   }
   ```
...
3. **TypeScript Stories**
   ...
   const Template: ComponentStory<typeof TypedButton> = (args: React.ComponentProps<typeof TypedButton>) => (
     <TypedButton {...args} />
   );
...
<Canvas>
  <Story of={MyComponentStories.Default} />
</Canvas>
...
<Canvas>
  <Story of={MyComponentStories.Variant} />
</Canvas>
