...
- **<LinkTo kind="getting-started-integration-hydration-guide" story="docs">Hydration guide</LinkTo>** — adding `fromElement` prop extraction for server-rendered integration (Drupal, Astro)
