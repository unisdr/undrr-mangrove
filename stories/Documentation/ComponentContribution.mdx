...
- **2.1** — 2026-02-20: Description of the change
- **2.0** — 2026-01-15: **Breaking:** Description of breaking change
- **1.0** — 2025-11-01: Released component
```

**Rules:**

- **Heading level**: Always `## Changelog` (H2)
- **Entry format**: `- **version** — YYYY-MM-DD: description`
