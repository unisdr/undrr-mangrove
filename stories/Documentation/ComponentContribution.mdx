...
- [Hydration guide](https://github.com/unisdr/undrr-mangrove/blob/main/docs/HYDRATION.md) — adding `fromElement` prop extraction for server-rendered integration (Drupal, Astro)
- [Release process](https://github.com/unisdr/undrr-mangrove/blob/main/docs/RELEASES.md) — versioning, tagging, and publishing
- [Architecture](https://github.com/unisdr/undrr-mangrove/blob/main/docs/ARCHITECTURE.md) — build system, distribution channels, and Drupal integration
- [Component guide](https://github.com/unisdr/undrr-mangrove/blob/main/docs/COMPONENT-GUIDE.md) — step-by-step tutorial for building a new component
