...
Standards, conventions, and contribution process for Mangrove components. For a step-by-step tutorial on building a new component, see the <LinkTo kind="getting-started-build-a-component" story="docs">Build a component</LinkTo> guide.
...
- **<LinkTo kind="getting-started-build-a-component" story="docs">Build a component</LinkTo>** — step-by-step tutorial
