...
> For the full testing reference, including coverage requirements and CI details, see [docs/TESTING.md](https://github.com/unisdr/undrr-mangrove/blob/main/docs/TESTING.md) in the repository.
