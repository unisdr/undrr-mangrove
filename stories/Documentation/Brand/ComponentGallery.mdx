...
| Feature promo  | Editorial spotlight with image/panel overlap; four colour variants          | <LinkTo kind="components-featurepromo" story="docs">View</LinkTo>     |
...
| Syndication search | Cross-site content search widget   | <LinkTo kind="components-syndicated-search" story="docs">View</LinkTo> |
