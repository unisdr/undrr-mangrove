...
{/* prettier-ignore */}
For the strategic model behind these guidelines (core UNDRR → sub-brand → campaign), see <LinkTo kind="brand-layered-identity" story="docs">Layered identity</LinkTo>. For practical voice and tone direction, see <LinkTo kind="brand-visual-voice" story="docs">Visual voice</LinkTo>, <LinkTo kind="brand-written-voice" story="docs">Written voice</LinkTo>, <LinkTo kind="brand-audience-mapping" story="docs">Audience mapping</LinkTo>, <LinkTo kind="brand-anti-patterns" story="docs">Anti-patterns</LinkTo>, and <LinkTo kind="brand-ai-imagery-prompts" story="docs">AI imagery prompts</LinkTo>.
