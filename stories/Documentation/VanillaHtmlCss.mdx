...
<Meta
  title="Getting started/Integration/Vanilla HTML and CSS"
  parameters={{
    viewMode: 'docs',
    previewTabs: {
      canvas: { hidden: true },
...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://assets.undrr.org/static/mangrove/1.6.0/css/style.css"
    />
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/1.6.0/css/style-preventionweb.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/1.6.0/css/style-mcr.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/1.6.0/css/style-irp.css"
/>
```

**DELTA Resilience** — deltaresilience.org

```html
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/1.6.0/css/style-delta.css"
/>
```
...
> **Full-page example:** The [DELTA Resilience homepage on CodePen](https://codepen.io/khawkins98/pen/019d3720-5233-796f-ae0a-dc141475a30f) demonstrates a complete integration — vanilla HTML for PageHeader, Hero, IconCard, TextCta, and Footer with React hydration for MegaMenu and SyndicationSearchWidget. No build tooling required.
...
Last updated: 18 March 2026 · <a href="https://github.com/unisdr/undrr-mangrove/blob/main/stories/Documentation/VanillaHtmlCss.mdx" target="_blank" rel="noopener noreferrer">View source on GitHub</a>
