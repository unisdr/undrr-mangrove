...
<html lang="en">
  <head>
    ...
    <!-- <link rel="stylesheet" href="https://assets.undrr.org/static/mangrove/1.2.11/assets/css/style-preventionweb.css"> -->
  </head>
  <body>
    <!-- Your content here -->
  </body>
...
<script type="module">
  ...
  import {
    mgTabs,
    mgTabsRuntime,
  } from 'https://assets.undrr.org/static/mangrove/1.2.11/assets/js/tabs.js';
