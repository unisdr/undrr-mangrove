...
For production use, Mangrove ships a `createHydrator` helper that eliminates the boilerplate above. Components that support hydration export a `fromElement` function that extracts props from data attributes on the container element:
