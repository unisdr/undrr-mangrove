...
These practices keep your implementation consistent with the rest of Mangrove. See **<LinkTo kind="getting-started-what-mangrove-is" story="docs">What Mangrove is</LinkTo>** for background on what's shared and why.
