...
These practices keep your implementation consistent with the rest of Mangrove. See **<LinkTo kind="getting-started-about-mangrove" story="docs">About Mangrove</LinkTo>** for background on what's shared and why, and **<LinkTo kind="design-decisions-content-architecture" story="docs">Content architecture: schemas</LinkTo>** for the formal contracts defining what data each component carries.
...
- <LinkTo kind="getting-started-about-mangrove" story="docs">About Mangrove</LinkTo> -- what's shared across UNDRR properties
- <LinkTo kind="design-decisions-content-architecture" story="docs">Content architecture: schemas</LinkTo> -- formal contracts for what each component carries
- <LinkTo kind="getting-started-accessibility" story="docs">Accessibility</LinkTo> -- WCAG requirements and patterns
- <LinkTo kind="contributing-component-standards" story="docs">Component standards</LinkTo> -- code conventions for contributors
