...
These patterns keep components consistent across UNDRR web properties. See **<LinkTo kind="getting-started-about-mangrove" story="docs">About Mangrove</LinkTo>** for the broader context.
...
│   ├── Breadcrumbs/      # Component category
...
8. **Changelog** - Version history (see the [component contribution guide](?path=/docs/getting-started-component-contribution-guide--docs#changelog-format) for the required format)
...
Last updated: 18 March 2026 · <a href="https://github.com/unisdr/undrr-mangrove/blob/main/stories/Documentation/ComponentStructure.mdx" target="_blank" rel="noopener noreferrer">View source on GitHub</a>
