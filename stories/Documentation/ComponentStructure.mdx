...
These patterns keep components consistent across UNDRR web properties. See **<LinkTo kind="getting-started-what-mangrove-is" story="docs">What Mangrove is</LinkTo>** for the broader context.
