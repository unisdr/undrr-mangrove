...
**Example:**
```html
<link rel="stylesheet" href="https://assets.undrr.org/static/mangrove/1.2.13/css/style.css" />
```
...
```html
<script type="module">
  import { mgTabs } from 'https://assets.undrr.org/static/mangrove/1.2.13/js/tabs.js';
  mgTabs();
</script>
```
