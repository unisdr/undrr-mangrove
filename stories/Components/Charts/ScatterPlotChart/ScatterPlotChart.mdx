...
> **⚠ Deprecated.** This component is deprecated as of v1.7.x and will be removed in **v1.8**. UNDRR is consolidating on [Recharts](https://recharts.org/) for charting; this in-tree D3 wrapper never reached wide-scale implementation. New code should use Recharts directly. See the [removal tracker](https://github.com/unisdr/undrr-mangrove/issues/1011) for the migration plan.
...
<Canvas of={ScatterPlotChartStories.DefaultConnectedScatterplot} meta={ScatterPlotChartStories} />
...
<Canvas of={ScatterPlotChartStories.CustomRtlConnectedScatterplot} meta={ScatterPlotChartStories} />
...
<Canvas of={ScatterPlotChartStories.CustomConnectedScatterplot} meta={ScatterPlotChartStories} />
...
- **1.1** — 2026-05-12: Deprecated. Will be removed in v1.8; new code should use [Recharts](https://recharts.org/). The earlier "proof of concept not used in production" note is superseded by the formal deprecation. See the [removal tracker](https://github.com/unisdr/undrr-mangrove/issues/1011).
