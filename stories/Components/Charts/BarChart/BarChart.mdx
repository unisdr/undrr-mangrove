...
These examples show data fetching combined with chart rendering. Fetcher and Loader are not required to render a bar chart — they are used here to demonstrate full integration with live API data.
...
- **1.1** — 2026-05-12: Deprecated. Will be removed in v1.8; consumers should migrate to [Recharts](https://recharts.org/). See the [removal tracker](https://github.com/unisdr/undrr-mangrove/issues/1011).
- **1.0** — 2024-08-08: Initial release
