...
<Meta title="Components/Charts/Histogram" component={Histogram} />
...
<Canvas>
  <Story name="Multiple Series Histogram">
    {() => (
      <Histogram
        dataSeries={[
          { 
...
<Canvas>
  <Story name="Overlapping Histogram">
    {() => (
      <Histogram
        dataSeries={[
          { 
