...
> **Implementation note (for contributors):** The following describes internal architecture decisions for this component. Consumers do not need to understand these details to use the Gallery.
