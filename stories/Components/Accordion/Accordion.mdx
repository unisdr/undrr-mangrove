...
- [Base layouting CSS](https://assets.undrr.org/static/mangrove/1.2.13/assets/css/foundation.min.css).
- [Copy and add this component CSS in your project](https://assets.undrr.org/static/mangrove/1.2.13/assets/css/components/accordion.min.css).
