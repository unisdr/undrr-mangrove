...
(NOTE: This is yet to be adapated to the UNDRR system and styles. This will likely be removed in favor of the stacked tabs variant.)
...
<Canvas of={AccordionStories.DefaultAccordion} meta={AccordionStories} />

#### CSS

Add following CSS in your project

- [Base layouting CSS](https://assets.undrr.org/static/mangrove/1.2.12/assets/css/foundation.min.css).
- [Copy and add this component CSS in your project](https://assets.undrr.org/static/mangrove/1.2.12/assets/css/components/accordion.min.css).

#### JS

The Accordion component now uses React state management and does not require external JavaScript files. All functionality is built into the React component.
