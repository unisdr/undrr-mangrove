...
- [Base layouting CSS](https://assets.undrr.org/static/mangrove/1.3.0/assets/css/foundation.min.css).
- [Copy and add this component CSS in your project](https://assets.undrr.org/static/mangrove/1.3.0/assets/css/components/accordion.min.css).
