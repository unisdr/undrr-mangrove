...
- **1.4** — 2026-04-13: `.mg-hero__title` now uses `$mg-font-family-headings` (Roboto Condensed) to match the brand spec for headings. Added a `:lang(ar)` block routing to `$mg-font-family-arabic-headings`.
