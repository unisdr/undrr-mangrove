...
The `MapComponent` uses Leaflet to render markers representing data points. Each marker displays a tooltip with detailed information about the data point when clicked.
