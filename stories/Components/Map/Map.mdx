...
> **⚠ Deprecated.** This component is deprecated as of v1.7.x and will be removed in **v1.8**. UNDRR is adopting UNEP/GRID [MAPX](https://mapx.org/) as the standard mapping technology; this in-tree Leaflet wrapper never reached wide-scale implementation. New code should embed MAPX directly. See the [removal tracker](https://github.com/unisdr/undrr-mangrove/issues/1011) for the migration plan.
...
- **1.1** — 2026-05-12: Deprecated. Will be removed in v1.8; consumers should migrate to UNEP/GRID [MAPX](https://mapx.org/), UNDRR's adopted mapping technology. See the [removal tracker](https://github.com/unisdr/undrr-mangrove/issues/1011).
