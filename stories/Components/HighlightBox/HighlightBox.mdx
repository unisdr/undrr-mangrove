...
- **1.2** — 2026-05-07: Inline white text color for `primary` and `secondary` variants so they remain legible when rendered in Storybook MDX docs pages where the theme stylesheet is not loaded by the story decorator. ([#926](https://github.com/unisdr/undrr-mangrove/issues/926))
