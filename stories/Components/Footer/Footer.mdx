...
The Footer component combines site-specific content with UNDRR's global syndicated footer, giving you the flexibility to add complementary information while maintaining consistent UNDRR branding across all network sites.
...
<Canvas>
  <Story of={FooterStories.WithComplementaryContent} />
</Canvas>
...
| `syndicationConfig` | object | See below | Configuration for the syndication widget |
...
### Version 1.0: Initial UNDRR-based release