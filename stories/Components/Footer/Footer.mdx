...
- **1.0.0-beta.2** — 2026-03-14 ([web-backlog#2630](https://gitlab.com/undrr/web-backlog/-/work_items/2630)): Added `mg-footer-bar` utility component for sub-branded site footer navigation. Footer social links now inherit color from parent container instead of forcing white (the parent `.mg-footer--about-footer` already sets white link color). Default `includecss` changed to `false` to avoid double-loading CSS that Mangrove provides.
