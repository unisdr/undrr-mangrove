...
<Canvas of={LanguageSwitcherStories.LanguageSwitcher} meta={LanguageSwitcherStories} />
...
- https://assets.undrr.org/static/mangrove/1.2.11/assets/js/lang-switcher.js
