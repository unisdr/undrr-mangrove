...
It consists of a title "On this page" followed by a list of links to the page sections.
...
<Canvas>
  <Story of={TableOfContentsStories.TableOfContentsStory} />
</Canvas>
...
2. Prepare your table of contents data:
   ...
   const tocData = [
     ...
     { id: "section-3", text: "Section 3 Title" },
   ];
   ```
