...
- **2.0.0** — 2026-03-29: **Breaking.** Prop rename to align with canonical statistic schema ([#884](https://github.com/unisdr/undrr-mangrove/issues/884)): `stats[].summaryText` → `stats[].summary`. Drupal consumers passing `data-stats` JSON blobs must update the item shape. See [migration guide](https://github.com/unisdr/undrr-mangrove/blob/main/docs/MIGRATION-SCHEMA-V2.md).
