...
If you're working on a plain HTML site (no React), you don't need this React wrapper. For Drupal and other server-rendered contexts, these three tags are the recommended integration — no React wrapper is needed. Simply include the following tags and the banner will initialise automatically:
