...
A search widget initialized with a search query.

<Canvas of={SyndicationSearchWidgetStories.WithQuery} meta={SyndicationSearchWidgetStories} />

## Without Facets Sidebar

A minimal search widget without the facets sidebar.

<Canvas of={SyndicationSearchWidgetStories.WithoutFacets} meta={SyndicationSearchWidgetStories} />
...
Shows search performance metrics for debugging.

<Canvas of={SyndicationSearchWidgetStories.WithMetrics} meta={SyndicationSearchWidgetStories} />
...
<Canvas of={SyndicationSearchWidgetStories.WithCustomFilters} meta={SyndicationSearchWidgetStories} />
...
<Canvas of={SyndicationSearchWidgetStories.WithCustomFacets} meta={SyndicationSearchWidgetStories} />
...
## Combined Custom Filters & Facets

Use both together: `customFilters` for hidden constraints, `customFacets` for user choices.

<Canvas of={SyndicationSearchWidgetStories.WithBothCustomOptions} meta={SyndicationSearchWidgetStories} />
...
| `defaultSort` | string | `'newest'` | Initial sort order (`newest`, `oldest`, `relevance`) |
