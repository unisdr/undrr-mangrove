...
const getCaptionForLocale = locale => {
  switch (locale) {
    ...
    case 'arabic':
      const arabicText = {
        blockquote:
          '"بصفته مكتب الأمم المتحدة للحد من مخاطر الكوارث، يجمع المكتب الحكومات والشركاء والمجتمعات معًا للحد من مخاطر الكوارث والخسائر ولضمان مستقبل أكثر أمانًا واستدامة."',
        cite: '—الاسم الأول الاسم الأخير',
      };
      return arabicText;
    case 'burmese':
      const burmeseText = {
