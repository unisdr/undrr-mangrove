...
The Cloudflare Turnstile widget is [WCAG 2.1 Level AA compliant](https://developers.cloudflare.com/turnstile/frequently-asked-questions/). Most visitors pass the managed challenge automatically with no interaction required.

> **Implementation note (for contributors):** The neutral background (`#f2f2f2`) and teal accent deliberately diverge from the blue error page palette to signal "routine verification checkpoint", not an error state. The centered card follows UX research on reducing CAPTCHA friction. Design references:
>
...
> - [Cloudflare additional configuration](https://developers.cloudflare.com/cloudflare-challenges/challenge-types/challenge-pages/additional-configuration/)
> - [CAPTCHA can ruin your UX (Auth0)](https://auth0.com/blog/captcha-can-ruin-your-ux-here-s-how-to-use-it-right/)
> - [Cloudflare Turnstile accessibility (WCAG 2.1 AA)](https://developers.cloudflare.com/turnstile/frequently-asked-questions/)
...
```text
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/5xx.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/challenge.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/managed-challenge.html
```

**Individual error pages** (for platforms that support per-code configuration):
```text
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/401.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/403.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/404.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/429.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/500.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/502.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/503.html
https://assets.undrr.org/static/mangrove/1.6.0/error-pages/504.html
```
