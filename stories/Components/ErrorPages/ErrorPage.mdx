...
- **1.4.0** — 2026-03-21: Converted inline styles from 10px-root rem values to px. Static templates now work correctly with the standard 1.4 theme (no root font-size override).
