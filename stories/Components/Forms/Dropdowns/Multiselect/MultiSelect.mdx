...
* https://assets.undrr.org/testing/static/mangrove/latest/assets/css/components/multi-select.min.css
* https://assets.undrr.org/testing/static/mangrove/latest/assets/css/components/checkbox.min.css
* https://assets.undrr.org/testing/static/mangrove/latest/assets/css/components/radio.min.css
