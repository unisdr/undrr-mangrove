...
<Canvas of={InputFieldsStories.Date} meta={InputFieldsStories} />

<Canvas of={InputFieldsStories.Number} meta={InputFieldsStories} />

<Canvas of={InputFieldsStories.Password} meta={InputFieldsStories} />

<Canvas of={InputFieldsStories.Telephone} meta={InputFieldsStories} />

<Canvas of={InputFieldsStories.Text} meta={InputFieldsStories} />

### Usage

1. Choose the state Default, Focus, Error, and Disabled from the control tab of the canvas.
2. Copy the HTML from the HTML tab.
