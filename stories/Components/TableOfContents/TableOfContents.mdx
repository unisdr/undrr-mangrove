...
standalone script from `stories/assets/js/table-of-contents.js` (published to npm
as `@undrr/undrr-mangrove/js/table-of-contents.js`):

```html
<script type="module" src="path/to/table-of-contents.js"></script>
```
...
```js
import { mgTableOfContents } from 'stories/assets/js/table-of-contents.js';
...
- **1.5** — 2026-04-02 ([web-backlog#2739](https://gitlab.com/undrr/web-backlog/-/issues/2739)): Published vanilla JS as standalone asset in `assets/js/table-of-contents.js` with auto-init support and `data-mg-table-of-contents-content` selector
