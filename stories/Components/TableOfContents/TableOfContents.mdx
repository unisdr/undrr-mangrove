...
<script
  type="module"
  src="https://assets.undrr.org/static/mangrove/1.6.0/js/table-of-contents.js"
></script>
```
...
```js
import { mgTableOfContents } from 'https://assets.undrr.org/static/mangrove/1.6.0/js/table-of-contents.js';
