...
- **1.1** — 2026-03-05 ([web-backlog#2661](https://gitlab.com/undrr/web-backlog/-/issues/2661)): Added optional `size` prop to Paragraph component for applying font-size utility classes
