...
import sample_imagelg from "../../../assets/images/sample_image-lg.png";
import sample_imagemd from "../../../assets/images/sample_image-md.png";
import sample_imagesm from "../../../assets/images/sample_image-sm.png";
...
<Canvas>
  <Story name="Image with credit + caption" parameters={{ docs: { source: { code: `<div class="grid-x image-section">
    ...
    {(args, { globals: { locale } }) => {
      ...
      return (
        <Images
          imagelg={sample_imagelg} imagemd={sample_imagemd} imagesm={sample_imagesm} alt="farmland" label={caption.label}  paragraph={caption.paragraph} {...args}
        ></Images>
      );
    }}
  </Story>
...
- https://unisdr.github.io/undrr-mangrove/css/base.min.css
