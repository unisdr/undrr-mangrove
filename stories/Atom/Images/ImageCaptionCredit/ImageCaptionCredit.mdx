...
<Canvas>
  <Story of={ImageCaptionCreditStories.DefaultImageWithCreditCaption} />
</Canvas>
...
* https://assets.undrr.org/testing/static/mangrove/latest/assets/css/components/image-caption.min.css
