...
- **AI imagery hard-bans** ([#983](https://github.com/unisdr/undrr-mangrove/pull/983)) — explicit standing rules: no photorealistic AI of human beings (stylised illustration only); no AI imagery for named people or specific real events; no AI-generated images of children; named country required (no regional pastiche); disability inclusion required in every people-inclusive prompt; decolonial framing required.
- **New AI agent: UN Brand Strategist** ([#983](https://github.com/unisdr/undrr-mangrove/pull/983)) — strategic / external-consultant lens for UNDRR's layered identity at `.claude/agents/un-brand-strategist.md`. Distinct from the tactical Brand Guardian (token consistency). Includes audit scoring rubric and layered-identity brief template.
