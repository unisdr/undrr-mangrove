...
[![React Doctor](https://www.react.doctor/share/badge?p=%40undrr%2Fundrr-mangrove&s=68&e=31&w=303&f=123)](https://www.react.doctor/share?p=%40undrr%2Fundrr-mangrove&s=68&e=31&w=303&f=123)
...
Drupal.behaviors.mangroveComponentName = {
  attach(context) { hydrator.update(context); },
};
```
