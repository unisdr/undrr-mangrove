...
- **AI imagery prompts** (${DOCS_BASE}?path=/docs/brand-ai-imagery-prompts--docs): The cookbook. Three holistic example prompts (hero illustration with people; conceptual diagram with no people; infographic background). The UNDRR prompt formula: \`[your subject] + [UNDRR style block] + [output spec]\` with copy-paste style blocks for with-people and no-people cases. Sub-brand colour-swap table. An LLM meta-prompt to paste into ChatGPT or Claude with a rough brief (e.g. "I want something about financing for DRR") that returns an on-brand image prompt. Plus language-model prompts for alt text, headlines, tone register, British-English conversion, and sentence case.
