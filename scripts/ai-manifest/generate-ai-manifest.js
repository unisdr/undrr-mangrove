...
- **Written voice** (${DOCS_BASE}?path=/docs/brand-written-voice--docs): Four voice registers (Urgent, Authoritative, Warm, Hopeful) mapped to content type, plus house conventions: British English (Oxford spelling), sentence case, em-dashes in body prose only (never in UI), descriptive link text, gender-neutral and disability-inclusive language. Common rewrites table for register drift.
